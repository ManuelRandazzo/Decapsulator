...
typedef enum __sequence__ : uint8_t
{
    ...
    PUNCHER_FIRST_DOWN_FAST_STATE,
    PUNCHER_FIRST_DOWN_SLOW_STATE,
    PUNCHER_FIRST_UP_FAST_STATE,
    PUNCHER_SECOND_DOWN_FAST_STATE,
    PUNCHER_SECOND_DOWN_SLOW_STATE,
    PUNCHER_SECOND_UP_FAST_STATE,
} Sequence_t;
