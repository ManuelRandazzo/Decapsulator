 ...
 * 
 */
#define PIECE_PRESENCE_PIN 255  /** @warning  Ancora da definire*/
#define PIECE_PASSED_PIN   255  /** @warning  Ancora da definire*/
 ...
 * 
 */
#define SERVO_PIN         20   /** @warning Ancora da definire. Pin del servo motore */
...
#define RALLA_SPEED_MOVEMENT  360.0         // Velocità di esecuzione relativo al tamburo in gradi al secondo [°/s]
#define GEAR_RATIO_PUNZONE    3             // Imposta un gear ratio 1/3 per la ralla

/// Driver DRV8825 pins
#define RALLA_DIRECTION_PIN   4             /** @warning  Ancora da definire*/
#define RALLA_STEP_PIN        5             /** @warning  Ancora da definire*/
#define RALLA_ENABLE_PIN      15            /** @warning  Ancora da definire*/
#define RALLA_RESET_PIN       7             /** @warning  Ancora da definire*/
#define RALLA_SLEEP_PIN       6             /** @warning  Ancora da definire*/
#define RALLA_FAULT_PIN       16            /** @warning  Ancora da definire*/


/// Parametri HOMING
#define RALLA_CALIB_PIN       255           /** @warning  Ancora da definire*/
#define RALLA_TRIGGER_MODE    FALLING
#define RALLA_HOME_SPEED      30            /** Gradi al secondo*/
#define RALLA_MICROSTEP       STEP_1_TO_16
...
#define PUNZ_MAX_POS_PIN 255 /** @warning  Ancora da definire*/
#define PUNZ_MIN_POS_PIN 255 /** @warning  Ancora da definire*/

#define PUNZ_CALIB_PIN          255           /** @warning  Ancora da definire*/
#define PUNZ_TRIGGER_MODE       CHANGE
#define PUNZ_HOME_SPEED         30            /** Gradi al secondo*/
#define PUNZ_MICROSTEP          STEP_1_TO_16
...
void prgDecapsulatorTask(void *pvParameters)
{
  ...
  int nCapsuleNellaRalla = 0; // prende il numero dalla SD Card
  ...
  while(1)
  {
    ...
    switch(sequenza)
    {
      ...
      case MACHINE_STARTUP_STATE :
        ...
        if(digitalRead(EMERGENCY_STOP_PIN) == HIGH && digitalRead(MACHINE_OPEN_PIN) == HIGH && 
           digitalRead(nFAULT_TAMBURO) == HIGH && digitalRead(nFAULT_PUNZONE) == HIGH)
        {
          ...
          if(punzone_in_max_pos == true && punzone_in_min_pos == false && ralla_calibrated == true)
          {
      ...
      case QUIETE_STATE :
        ...
        if(startCycleFromHMI && digitalRead(PIECE_PRESENCE_PIN))
      ...
      case REACH_NEXT_STATION_STATE :
        if(MotRalla.isStepDone() && MotPunzone.isStepDone())
        {
          ...
          MotRalla.moveRel(+90.0 * GEAR_RATIO_PUNZONE, RALLA_SPEED_MOVEMENT);
    ...
    LogInfo("MotRalla", "Sto eseguendo la task di loop");
