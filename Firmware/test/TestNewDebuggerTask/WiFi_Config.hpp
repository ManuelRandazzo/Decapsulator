...
#define MQTT_BROKER "mqtt://*****:1883" /// Usa l'mqtt broker che gira sulla raspberry
...
#define __HIDDEN_PASSWORD_ESP_MQTT_FOR_DETAILED_LOGS "SuperUserDoPassword"

/// Decapsulator ESP pagina manutenzione della ui "Super User Do" 
#define __HIDDEN_PASSWORD_DECAPSULATOR_MANUTENCTOR "*****"
